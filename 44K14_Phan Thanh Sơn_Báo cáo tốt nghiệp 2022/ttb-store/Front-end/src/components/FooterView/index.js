      ...
      <div className="container p-tb-32">
        <p className="t-center" style={{ color: '#888' }}>
          <span className="font-size-18px">
            CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ QH STORE
          </span>
          <br />
          <strong>Trụ sở:</strong>&nbsp;150 Lê Duẩn - Đồng Hà - Quảng Trị
          <br />
          <strong>Văn phòng:</strong>&nbsp; 150 Lê Duẩn - Đồng Hà - Quảng Trị
          <br />
          <strong>Điện&nbsp;thoại:</strong>&nbsp;037.208.2758 |{' '}
        </p>
        <div className="d-flex align-i-center justify-content-center">
          ...
          <div className="d-flex align-i-center m-lr-32">
            ...
            <div className="t-center m-l-16">
              ...
              <h2 style={{ color: '#CE1F26' }}>037.208.2758</h2>
            </div>
          </div>
